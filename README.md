...
问我有啥问题，我说你们是工程实现为主是吗，他们说是，广告商如果投放了广告效果不好，我们告诉他怎么投放，比较偏业务。（程序员说的偏业务我有误解呜呜呜）问深度学习用的多吗，他

说模型优化的时候他问feature数量，说了下自己遇到模型优化的见解和普遍做法：接下来更多的是深入算法内部进行优化，但是从工程上算法内部优化带来的影响可以忽略不计。拼命解释+1，说不止考虑了样本量问题，确实往算法内部去优化了，并且这个补差最终就是达到了1% 2%这样的差距，呼应了他说小差距可以不用管的说辞...这么看更多时候就是样本量决定效果上限，从他看来这个优化没有意义。 表示
